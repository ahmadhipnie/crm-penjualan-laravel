        ...
        <div class="navbar w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item mt-3">
                    <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">FURNITURE MANAGEMENT</h6>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::routeIs('admin.barang.*') ? 'active' : '' }}"
                       href="{{ route('admin.barang.index') }}">
                        ...
                        <span class="nav-link-text ms-1">Produk Furniture</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::routeIs('admin.jenis-ekspedisi.*') ? 'active' : '' }}"
                       href="{{ route('admin.jenis-ekspedisi.index') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-delivery-fast text-primary text-sm opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1">Jenis Ekspedisi</span>
                    </a>
                </li>
                <li class="nav-item mt-3">
                ...
                <li class="nav-item mt-3">
                    <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">SALES MANAGEMENT</h6>
                </li>
                <li class="nav-item">
