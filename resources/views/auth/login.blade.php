...
<head>
    ...
    <title>CRM Furniture - Login</title>
    <!--     Fonts and icons     -->
                    ...
                    <div class="row">
                            ...
                            <div class="card card-plain">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between mt-3">
                                        <a href="{{ route('ShowRegister') }}" class="btn btn-info w-45">Pergi ke Register</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div
                            ...
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                ...
                                <p class="text-white position-relative">Lorem Ipsum Dolor sir amet i dont know to
                                    continue the spell</p>
                            </div>
                        </div>
                    </div>
                </div>
